<div class="">
    ...
    @foreach ($kelasdatas as $kelas)
        @if ($kelas->murid->isNotEmpty())  {{-- Hanya tampilkan kelas yang punya siswa --}}
            <div class="mt-4">
                <h3 class="text-primary">{{ $kelas->nama }}</h3> <!-- Nama Kelas -->
                <div class="row">
                    @foreach ($kelas->murid as $murid)
                        <div class="col-md-3 p-3">
                            <div class="card shadow-lg rounded-lg border" style="width: 100%;">
                                <img class="card-img-top" 
                                     src="{{ is_null($murid->foto) && $murid->kelamin === 1 ? asset('assets/img/femstudimg.jpg') : 
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">
                                        ...
                                        <strong>Kelamin:</strong> {{ $murid->kelamin == 1 ? 'Perempuan' : 'Laki-laki' }}
                                    </p>
                                </div>
